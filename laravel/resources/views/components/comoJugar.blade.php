...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item bg-dark p-5 mt-5">
      <img class="d-block w-100" src="images/comoJugar3.png" alt="Third slide">
        <div class="carousel-caption d-none d-md-block">
          ...
          <p>Selecciona si jugar o ver la coleccion</p>
        </div>
    </div>
    <div class="carousel-item bg-dark p-5 mt-5">
    ...
    <div class="carousel-item bg-dark p-5 mt-5">
      <img class="d-block w-100" src="images/comoJugar5.png" alt="Fourth slide">
        <div class="carousel-caption d-none d-md-block">
          <h4>ENCUENTRA LAS PAREJAS</h4>
    ...
    <div class="carousel-item bg-dark p-5 mt-5">
      <video class="d-block w-100" src="images/VideoTutorial_Parejas.mp4" alt="Fourth slide" controls></video>
        <div class="carousel-caption d-none d-md-block">
